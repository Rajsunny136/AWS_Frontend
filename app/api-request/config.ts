...
// config.API_DOMAIN_URL = "http://192.168.29.87:3000";
// config.GOOGLE_API_KEY = "AIzaSyCdUKj-j6A5yysU6wwkSfZF-2y-77qXofk";
// config.SOCKET_IO_URL = env == "prod" ? "" : "http://192.168.29.87:3000"; 

// export default config;

// export const origin = env == "prod" ? "" : "http://192.168.29.87:3000";
...
if (env === "production") {
    ...
    config.API_DOMAIN_URL = "http://192.168.29.87:3000"; // Development URL
    config.GOOGLE_API_KEY = "AIzaSyA9qviqi7tO8nndT6WAP_O5qr3NrfpILl0";
    config.SOCKET_IO_URL = "http://192.168.29.87:3000"; // Development Socket URL
}
